...
4. rectMode(CENTER), Es como si definieramos el punto de pivote del rectangulo Si no usas CENTER rota desde una esquina, pues es el punto de origen naturalmente del rectangulo. Si se usa  CENTER rota desde su centro.

5. La Relación entre ángulo y vector de velocidad es el concepto más importante.
